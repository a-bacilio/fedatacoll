...
function MyProjects() {
  ...
  return (
    <div className="w-full p-2 text-white">
      <TitleBox className="mb-10 text-2xl font-bold">Mis proyectos</TitleBox>
      ...
      <div className="flex flex-col items-center justify-center w-full">
        {isLoading && (
          <NotificationSpan className="w-full mx-auto text-center">
            Cargando...
          </NotificationSpan>
        )}
        {isError && (
        ...
        {isSuccess && data.length > 0 ? (
          <Card className="w-full max-w-5xl p-5 mt-5">
