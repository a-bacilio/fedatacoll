...
function RegisterForm(){
    ...
    const [postRegisterUser,{isSuccess,isError,isLoading,error}] = usePostRegisterUserMutation();
    const onSubmit = data => {
...
return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center p-5" >
        <InputLabel htmlFor="name">
            ...
            {errors.name && <NotificationSpan>Debes colocar tu nombre</NotificationSpan>}
        </InputLabel>
        ...
        <InputLabel htmlFor="email">
            ...
            {errors.email && <NotificationSpan>Debe colocar tu correo</NotificationSpan>}
        </InputLabel>
        
        <InputLabel htmlFor="password">
            Contraseña
            <InputField props={{...register("password", { required: true })}} type="password"/>
            {errors.password && <NotificationSpan>Debe colocar tu contraseña</NotificationSpan>}
        </InputLabel>
        
        <InputLabel htmlFor="passwordConfirmation">
            Confirme su contraseña
            <InputField props={{...register("passwordConfirmation", { required: true })}} type="string"/>
            {errors.passwordConfirmation && <NotificationSpan>Debe colocar su contraseña</NotificationSpan>}
        </InputLabel>
        
        
      <Button variation={2} type="submit">Registrese</Button>
